                          ...
                          completion:(void (^)())completion
{
    ...
    if (sign*(aPoints.a.v[axis] - bEndPoints.a.v[axis]) > 0.0f) {
        ...
        NSLog(@"Genie Effect Warning: The %@ edge of animated view overlaps %@ edge of %@ rect. Glitches may occure.",edgeDescription((edge + 2) % 4), edgeDescription(edge), reverse ? @"start" : @"destination");
    }
